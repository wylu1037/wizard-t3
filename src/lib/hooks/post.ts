...
export function useCheckPost<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: number; name?: string; createdById?: string }; }, options?: (Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
